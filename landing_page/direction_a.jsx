...
// Close to the existing page. Narrow centered column. Balanced 3-col grids.

function DirectionA({ lang }) {
  ...
  return (
    <div>
        ...
        <div style={{ display: "grid", gap: 18, gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
          {t.steps.map(({ n, t: title, d }, i) => (
            <div key={n} className="card" style={{ padding: 28, transitionDelay: `${i * 80}ms` }}>
              <div className="mono" style={{ fontSize: 11, letterSpacing: "0.14em", color: "var(--mute-2)", marginBottom: 22 }}>
                {n}
              </div>
      ...
      {/* Waitlist */}
      <section ref={waitlistRef} style={{ padding: "96px 24px" }}>
