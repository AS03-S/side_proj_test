          ...
          <Card>
            ...
            <CardContent>
              <p className="mb-3 text-xs text-neutral-500">
                Certa interface language. Document extraction and guidance will be provided in this language where available.
              </p>
                ...
                >
                  ...
                  <button
                    ...
                    className={`relative mt-0.5 h-5 w-9 rounded-full shrink-0 transition-colors ${
                      notifications[id] ? "bg-neutral-900" : "bg-neutral-200"
                    }`}
                  >
                    <span
              ...
              <div className="flex items-start justify-between gap-4 rounded border border-neutral-200 p-3">
                <div>
                  ...
                  <p className="mt-0.5 text-[10px] leading-relaxed text-neutral-500">
                    Share anonymised, non-identifiable usage data to help improve Certa. No document content or personal data is included.
                  </p>
                </div>
                <button
                  onClick={() => setShareData(!shareData)}
                  className={`relative mt-0.5 h-5 w-9 rounded-full shrink-0 transition-colors ${
                    shareData ? "bg-neutral-900" : "bg-neutral-200"
                  }`}
                >
                  <span
                    className={`absolute top-0.5 h-4 w-4 rounded-full bg-white shadow transition-transform ${
            ...
            <CardContent className="space-y-3">
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                <p className="text-xs leading-relaxed text-amber-900">
                  <strong>Certa provides structured information and document guidance only.</strong>{" "}
                  It does not provide legal advice, legal representation, legal eligibility assessments, or
                  official immigration determinations. Information provided through Certa is informational
                ...
                <p className="mt-2 text-xs leading-relaxed text-amber-900">
                  ...
                  or accredited legal representative. Extracted document data should always be verified
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <p className="text-xs text-neutral-500">
                ...
                All documents and guidance records will be permanently deleted.
              </p>
